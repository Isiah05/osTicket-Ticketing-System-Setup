# 🛠️ osTicket Configuration Lab – Help Desk Ticketing System
...
This project walks through the full setup of the **osTicket ticketing system**, showcasing how a Help Desk Technician might configure an internal ticketing platform used by IT support teams.

This includes:
- Installing osTicket on a Windows VM (localhost)
- Creating agents, users, departments, and SLAs
- Testing ticket creation and resolution workflows

---

## 🖥️ Environments Used
- Windows 10 Virtual Machine (Client)
- osTicket Web Interface (localhost)
...
- Installing and configuring web-based ticketing systems
- Creating departments, help topics, and user roles
- Setting up SLA (Service Level Agreement) plans
- Assigning agents and permissions
- Managing and resolving support tickets
- Simulating real-world help desk workflows
...
This lab simulates a real-world help desk configuration scenario using osTicket. From SLA policies and user setup to ticket resolution workflows, the lab prepares IT professionals for working with enterprise-level support systems.
